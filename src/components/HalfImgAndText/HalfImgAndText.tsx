...
export default function HalfImgAndText ({title, lead, text, picture, subtitles, isReverse, isButtonVisible = false}: HalfImgAndTextProps) {

  return (
    <section>
      <Container>
        <div className='py-4 lg:py-8 lg:px-8 lg:mx-8'>
          <div className={`flex flex-col ${isReverse ? "md:flex-row-reverse" : "md:flex-row" } items-center gap-4 lg:gap-8 `}>
